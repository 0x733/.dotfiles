...
[[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/hypr/hyprland.conf" ]] && cp "${XDG_CONFIG_HOME:-$HOME/.config}/hypr/hyprland.conf" "${XDG_CONFIG_HOME:-$HOME/.config}/hypr/hyprland.conf.bak"
...
! command -v zsh &> /dev/null && sudo pacman -Sy --noconfirm --needed zsh
