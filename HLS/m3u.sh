...
echo "Film süresi (dakika):"; read film_duration
echo "Film resmi URL'si:"; read film_logo
echo "Film video URL'si:"; read film_url
echo "Referrer URL'si:"; read referrer
referrer="${referrer%/}/"
echo -e "\n#EXTINF:$film_duration tvg-name=\"$film_name\" tvg-language=\"Turkish\" tvg-country=\"TR\" tvg-id=\"$film_name\" tvg-logo=\"$film_logo\" group-title=\"Korku\",$film_name" >> "$OUTPUT_FILE"
