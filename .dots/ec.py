...
def main(stdscr):
    ...
    while 1:
        ...
        if lang=='tr':
            ...
            stdscr.addstr(0,0,"Advanced Password Generator (Terminal)");stdscr.addstr(1,0,"Use the arrow keys to navigate, press Enter to change options or generate a password.")
        ...
        if k==ord('1'):
            ...
            s=not s
            if s:
                stdscr.clear();stdscr.addstr(0,0,"Kullanılacak sembolleri girin: ");stdscr.refresh();curses.echo();symbols_input=stdscr.getstr(0,28).decode('utf-8')
